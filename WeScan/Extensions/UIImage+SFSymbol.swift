...
extension UIImage {
    ...
    /// Creates an image object containing a system symbol image appropriate for the specified traits if supported
    /// (iOS13 and above). Otherwise an image object using the named image asset that is compatible with the specified trait collection will be created.
